...
class TestLayer5Canary(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.legit_token = "jwt_drone_1_valid"
        self.hacker_token = "jwt_hacker_stolen"
    ...
    def test_legitimate_api_request(self):
        ...
        self.assertIn(self.legit_token, self.gateway.active_tokens)
    ...
    def test_canary_trap_activation(self):
        ...
        self.assertNotIn(self.hacker_token, self.gateway.active_tokens)
