      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <motion.button
            ...
            onClick={() => handleRoleSelection('Rescue Team')}
            disabled={selectedRole !== null}
            className={`flex flex-col items-center justify-center p-10 rounded-2xl border transition-all duration-300 ${selectedRole === 'Rescue Team'
          ...
          <motion.button
            ...
            onClick={() => handleRoleSelection('Defence Agencies')}
            disabled={selectedRole !== null}
            className={`flex flex-col items-center justify-center p-10 rounded-2xl border transition-all duration-300 ${selectedRole === 'Defence Agencies'
                ? 'bg-[#00ffcc]/20 border-[#00ffcc]'
                : 'bg-white/5 border-white/10 hover:border-[#00ffcc]/50 hover:bg-white/10'
              }`}
          >
