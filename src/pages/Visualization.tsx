export default function Visualization() {
  return (
    <div className="fixed inset-0 w-screen h-screen z-[100] bg-black">
      {/* 
        This iframe embeds the exact vanilla JS 'drone-map' we built for 3D visualization. 
      ...
      */}
      ...
      <button
        ...
        className="absolute top-4 right-4 z-50 px-4 py-2 bg-gray-900/80 text-white rounded-full text-sm font-medium border border-white/10 hover:bg-gray-800 transition-colors backdrop-blur-md cursor-pointer"
      >
        ← Exit Simulation
      </button>
    </div>
