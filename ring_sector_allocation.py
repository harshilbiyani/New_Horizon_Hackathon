...
class RingSectorAllocator:
    ...
    def build_cells(self, n_drones: int, max_radius_m: float) -> List[dict]:
        # Enforce strict 5-drone ring sector distribution
        if n_drones == 5:
            return [
                {
                    "ring": 0,
                ...
                }, # Center
                {
                    "ring": 1,
                    "r_inner": 100.0,
                    "r_outer": max_radius_m,
                    "theta_start": 315 * math.pi / 180,
                    "theta_end": 45 * math.pi / 180,
                }, # North
                {
                    "ring": 1,
                    "r_inner": 100.0,
                    "r_outer": max_radius_m,
                    "theta_start": 45 * math.pi / 180,
                    "theta_end": 135 * math.pi / 180,
                }, # East
                {
                    "ring": 1,
                    "r_inner": 100.0,
                    "r_outer": max_radius_m,
                    "theta_start": 135 * math.pi / 180,
                    "theta_end": 225 * math.pi / 180,
                }, # South
                {
                    "ring": 1,
                    "r_inner": 100.0,
                    "r_outer": max_radius_m,
                    "theta_start": 225 * math.pi / 180,
                    "theta_end": 315 * math.pi / 180,
                }, # West
            ]
